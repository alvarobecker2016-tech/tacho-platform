# =========================================================
# POCKET DGSA & TACHO
# ENTERPRISE COMPLIANCE AI ENGINE v25 (SINGLE FILE VERSION)
...
class OCRService:
    def extract(self, image_bytes) -> Tuple[str, List[OCRTimelineEvent], float, str]:
        ...
        system_prompt = (
            ...
            "   - 'pictogram_raw': the EXACT character or symbol printed at the very start of that line (*, o, h, X).\n"
