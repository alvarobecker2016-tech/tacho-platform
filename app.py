...
UI = {
    ...
    "🇵🇹 PT": {"sub": "Sistema Legal B2B", "log_tab": "LOGIN", "reg_tab": "REGISTO", "email": "Email / ID", "pass": "Senha", "btn_log": "ENTRAR", "type": "Perfil:", "type_drv": "Motorista", "type_cmp": "Empresa", "name": "Nome", "cmp_name": "Empresa", "btn_reg": "CRIAR CONTA", "err_log": "Erro.", "err_reg": "Existe.", "ok_reg": "Criado.", "req_f": "Preencher.", "ready": "PRONTO PARA A ROTA", "desc": "Escreva...", "chat_ph": "Problema...", "attach": "📎 Câmera", "logout": "SAIR", "cfg": "AUTORIDADE:"},
    ...
    "🇮🇳 HI": {"sub": "पेशेवर B2B कानूनी प्रणाली", "log_tab": "लॉग इन", "reg_tab": "पंजीकरण", "email": "ईमेल / आईडी", "pass": "पासवर्ड", "btn_log": "दर्ज करें", "type": "प्रोफ़ाइल:", "type_drv": "ड्राइवर", "type_cmp": "कंपनी", "name": "पूरा नाम", "cmp_name": "कंपनी", "btn_reg": "खाता बनाएँ", "err_log": "त्रुटि।", "err_reg": "मौजूद है।", "ok_reg": "बनाया गया।", "req_f": "भरें।", "ready": "तैयार", "desc": "समस्या लिखें...", "chat_ph": "समस्या...", "attach": "📎 कैमरा", "logout": "लॉग आउट", "cfg": "प्राधिकरण:"},
...
.welcome-container { display: flex; flex-direction: column; align-items: center; justify-content: center; margin-top: 10vh; margin-bottom: 5vh; text-align: center; }
